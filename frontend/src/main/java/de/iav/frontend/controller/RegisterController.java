...
import de.iav.frontend.CrewConnect;
...
public class RegisterController {
    ...
    */
    ...
    protected void onClickBackButton(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(CrewConnect.class.getResource("/de/iav/frontend/fxml/login-scene.fxml"));
        Parent root;
        try {
            root = loader.load();
        } catch (IOException e) {
    ...
    public void register() {
        ...
        if (authService.registerAppUser(appUserRequest)) {
            FXMLLoader fxmlLoader = new FXMLLoader(CrewConnect.class.getResource("/de/iav/frontend/fxml/login-scene.fxml"));
            Parent root = null;
            try {
